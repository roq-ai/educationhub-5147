...
import { getStudentAssignmentById } from 'apiSdk/student-assignments';
...
function StudentAssignmentViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          ...
          {hasAccess('student_assignment', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/student-assignments/edit/${data?.id}`} passHref legacyBehavior>
              <Button
